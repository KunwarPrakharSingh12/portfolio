...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const serviceId = 'service_3ijv5ra'; // Replace with your EmailJS service ID
      const templateId = 'template_6oix6ox'; // Replace with your EmailJS template ID
      const publicKey = 'kJXXgriSABk-T7wAf'; // Replace with your EmailJS public key
  ...
  // ... keep existing code (contactMethods array)
  const contactMethods = [
    {
      icon: '📧',
      label: 'Email',
  ...
  return (
    <section id="contact" className="py-20 px-6 relative overflow-hidden">
      {/* ... keep existing code (background and header) */}
      <div className="absolute inset-0 bg-[url('/grid.svg')] opacity-5" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* ... keep existing code (Contact Methods and About Me sections) */}
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
