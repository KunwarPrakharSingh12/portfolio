...
const FloatingAvatar = () => {
  ...
  return <group ref={groupRef}>
      ...
      <mesh position={[0, 0, 0]}>
        ...
        <meshStandardMaterial color="#9d4edd" wireframe transparent opacity={0.3} emissive="#9d4edd" emissiveIntensity={0.1} />
      </mesh>
      
      {/* Inner Glow */}
      <mesh position={[0, 0, 0]}>
        <sphereGeometry args={[2, 32, 32]} />
        <meshStandardMaterial color="#0ea5e9" transparent opacity={0.1} emissive="#0ea5e9" emissiveIntensity={0.2} />
      </mesh>
    </group>;
};
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        {/* Text Content */}
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-8 text-center lg:text-left">
          <motion.div variants={itemVariants} className="space-y-4">
            <h1 className="text-5xl md:text-7xl font-bold leading-tight">
              <span className="block text-white text-3xl">Hello, I'm</span>
              <span className="block neon-text text-neon-purple typing-effect text-3xl">
